...
class DatastructureDropdown {
    static Create() {
        ...
        for (let datastructure in DSA) {
            ...
            h6.setAttribute('class', 'block w-full whitespace-nowrap bg-transparent px-4 py-2 text-sm font-semibold text-neutral-500 dark:text-neutral-200');
