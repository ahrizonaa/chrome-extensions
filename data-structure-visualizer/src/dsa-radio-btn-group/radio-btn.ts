...
RadioBtn.setAttribute(
	'class',
	`inline-block bg-primary px-6 pb-1.5 pt-1.5 text-xs font-medium uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-primary-600`
);
